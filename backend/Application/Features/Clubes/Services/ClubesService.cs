...
namespace Application.Features.Clubes.Services;
...
public class ClubesService : IClubesService 
{
    ...
    public async Task<Club> AddAsync(ClubesRequest clubesdto)
    {
    ...
    public async Task<Club> UpdateAsync(int id, ClubesRequest clubes)
    {
