...
namespace Application.Features.Selecciones.Services;

public class SeleccionService : ISelecionService
{
    private readonly ISeleccionRepository _repo;
    private readonly IFotoService _fotoService;

    public SeleccionService(ISeleccionRepository repo, IFotoService fotoService)
    {
        _repo = repo;
        _fotoService = fotoService;
    }

    public async Task<Seleccion> AddAsync(SeleccionesRequest seleccionesdto)
    {
    ...
    public async Task<Seleccion> UpdateAsync(int id, SeleccionesRequest seleccionesdto)
    {
