...
namespace Application.Features.SeleccionesEntrenadores.Services;

public class SeleccionEntrenadorService : ISeleccionEntrenadorService
{
    ...
    public SeleccionEntrenadorService(
    ...
    public async Task<SeleccionEntrenador> AddAsync(SeleccionEntrenadorRequest seleccioEntrenadorRequest)
    {
        ...
        var entrenadorSeleccion = new SeleccionEntrenador
        {
    ...
    public async Task<SeleccionEntrenador> UpdateAsync(
        int id,
    ...
    public async Task<SeleccionEntrenador> DespedirAsync(int id)
    {
        var entrenadorSeleccion = await _repository.GetByIdAsync(id)
            ?? throw new NotFoundException("La relación entrenador-selección no existe.");
