...
public class ClubesEntrenadorService : IClubesEntrenadorService
{
    ...
    public ClubesEntrenadorService(
    ...
    public async Task<ClubEntrenador> AddAsync(ClubesEntrenadorRequest clubesEntrenadorRequest)
    {
    ...
    public async Task<ClubEntrenador> UpdateAsync(int id, ClubesEntrenadorRequest clubesEntrenadorRequest)
    {
    ...
    public async Task<PagedResult<ClubesEntrenadorResponse>> ListarPorClub(int page, int pageSize, string? club)
    {
